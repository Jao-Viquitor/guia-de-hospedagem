  ...
  template: `
    <div class="flex flex-col items-center gap-6 p-4 max-w-md mx-auto">
      @if (isPdfMode()) {
        ...
        <a href="#contact" class="w-full flex flex-row items-center justify-center gap-4 p-4 bg-primary rounded-xl shadow-lg hover:brightness-95 transition-all duration-200">
        ...
        <button (click)="onSelect('contact')" class="w-full flex flex-row items-center justify-center gap-4 p-4 bg-primary rounded-xl shadow-lg hover:brightness-95 transition-all duration-200">
          <div class="text-white">
             <div class="w-8 h-8">
               <app-icon name="phone"></app-icon>
             </div>
